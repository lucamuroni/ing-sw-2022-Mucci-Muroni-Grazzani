...
public class NetworkHandler implements Network {
    ...
    @Override
    public void getUsernames(Game game) throws MalformedMessageException, TimeHasEndedException, ClientDisconnectedException {
    ...
    @Override
    public void getMergedIslands(Game game) throws AssetErrorException, MalformedMessageException, TimeHasEndedException, ClientDisconnectedException {
